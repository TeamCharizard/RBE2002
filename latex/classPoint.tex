...
Default construct with x and y = 0 
...
Construct with specified x and y values. 
...
return a new point rotated about the origin by the given angle. 
...
return a new point translated by the given point 


\begin{DoxyParams}{Parameters}
{\em p} & the point to translate by \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
