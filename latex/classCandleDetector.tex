...
Return the relative angle in degrees of the last candle found. 
...
Return the relative distance in mm of the last candle found. 
...
Return the point (x,y) of the candle relative to the robot when it was found. 
