...
get the lastest robot position 

\begin{DoxyReturn}{Returns}
the lastest robot position 
\end{DoxyReturn}


Definition at line 83 of file Odom.\-hpp.
...
\begin{DoxyReturn}{Returns}
get the number of ticks seen by the left encoder from the last update 
\end{DoxyReturn}


Definition at line 68 of file Odom.\-hpp.
...
\begin{DoxyReturn}{Returns}
get the number of ticks seen by the right encoder from the last update 
\end{DoxyReturn}


Definition at line 75 of file Odom.\-hpp.
...
{\em robot\-Point} & a point the the frame of the robot \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the input point trasnformed to world frame 
\end{DoxyReturn}


Definition at line 90 of file Odom.\-hpp.
...
Definition at line 26 of file Odom.\-hpp.
...
update the robots position based on encoder ticks since last update 

\begin{DoxyReturn}{Returns}
distance the robot has traveled forward (since the last update) 
\end{DoxyReturn}


Definition at line 44 of file Odom.\-hpp.
